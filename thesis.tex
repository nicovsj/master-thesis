...
\section{Proof of proposition \ref{prop:eVAconstruction}} \label{app:eVAconstruction}

\input{./chapters/appendix4.tex}

\newpage

\section{Proof of proposition \ref{prop:determinization}} \label{app:determinization}
