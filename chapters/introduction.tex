...
their inception in the late 1960s~\cite{thompson1968programming,earlyNFA}. The
...
domains.~\cite{Gonzalo}, literature~\cite{lit1}, or medicine~\cite{FloresFP21}. 
...
the so-called \emph{leftmost-longest} paradigm~\cite{posix}, meaning that they
...
that extends the theoretical algorithm of~\cite{FlorenzanoRUVV20} and
