...
theoretical algorithm presented in \cite{FlorenzanoRUVV20} for evaluating
...
An \emph{extended variable-set automaton} (\(\EVA\))~\cite{FaginKRV15} is a
...
by~\cite{FlorenzanoRUVV20} for an automaton model outputting sets of markers.
However, the eVA of~\cite{FlorenzanoRUVV20} require letter and variable
...
standard in the implementation of RegEx engines~\cite{cox2007regular}. The
