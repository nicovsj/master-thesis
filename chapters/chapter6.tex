...
\begin{enumerate}
	...
	the BLAST initiative~\citep{blast}. The combined size of this dataset is 38.5
	...
	by the Linked SPARQL Queries Dataset team \citep{LSQ}. We merged all the logs
...
\begin{enumerate}
	...
	provided by \citep{morphemes}. We then specify queries that look for
	...
	database~\citep{prosite} that commonly occur in our dataset. Our queries take
